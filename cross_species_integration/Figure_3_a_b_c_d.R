...
subclasses <- c("L2/3 IT", "L5 IT", "L6 IT", "L6 IT Car3", "L6 CT", "L6b", "L5 ET", "L5/6 NP")
...
DoHeatmap(data_to_plot, assay = "SCT", slot = "scale.data", features = unique(genes_to_plot)) +
  ...
  theme(axis.text.y = element_text(size = 2)) + NoLegend()
DoHeatmap(data_to_plot, assay = "SCT", slot = "scale.data", features = unique(genes_to_plot)) +
  scale_fill_gradientn(colors = c("white", "white", "royalblue1")) +
  theme(axis.text.y = element_text(size = 2)) + NoLegend()
DoHeatmap(data_to_plot, assay = "SCT", slot = "scale.data", features = unique(genes_to_plot)) +
  scale_fill_gradientn(colors = c("white", "white", "maroon4")) +
  theme(axis.text.y = element_text(size = 2)) + NoLegend()
DoHeatmap(data_to_plot, assay = "SCT", slot = "scale.data", features = unique(genes_to_plot)) +
